...
############Bold seqspec
 check4<-bold_seqspec("Urochloa brachyura")
 check2<-bold_seqspec("Tetracanthella brachyura")
...
# write_csv(FinalDF, "Just_Species_seqspec.csv")
# 
# Just_Species_seqspec <- read_csv("Just_Species_seqspec.csv")
# FinalDF <- Just_Species_seqspec
# 
# write.csv(Taxa_final, "Taxa_Final_save.csv")
# write.csv(Taxa_working, "Taxa_working_save.csv")
# 
# Taxa_final <- read.csv("Taxa_Final_save.csv")
# Taxa_working <- read.csv("Taxa_working_save.csv")
...
Just_Speceis_Jan_Gap_analysis <- bind_rows(FinalDF, Missing_final)
Just_Speceis_Jan_Gap_analysis[, 8:15][is.na(Just_Speceis_Jan_Gap_analysis[, 8:15])] <- 0

write.csv(Just_Speceis_Jan_Gap_analysis, "Just_Speceis_Jan_Gap_analysis.csv")
